			...
			<AnimationsWrapper>
				<div className="container has-text-centered column is-half is-offset-one-quarter">
					...
					<div className="has-text-centered top20 bottom20">
						...
						<div>
							If you are enjoying this tool, we would be very glad if you would like to
							donate to:
							<br />
							<strong>17803167062369576486L</strong>
							<p>
								Carbonara and Endro are also looking for votes, if you would like to
								keep our mood high. feel free to vote him :)
							</p>
						</div>
