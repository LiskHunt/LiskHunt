...
class Resource extends Component {
  render() {
    ...
    const image = app_images[0]
      ? app_images[0]
      : 'https://dummyimage.com/200x200/cccccc/cccccc';

    return (
      <a
        onClick={() => this.props.goResource(resource_id)}
        className="resource-wrap"
      >
        <div className="resource-left-section">
          <img
            src={image}
            alt="logo of the resource"
            className="image resource-image"
          />
        </div>
