      ...
      <AnimationsWrapper>
        <div className="hero-body padded-content">
          <div className="container has-text-centered">
            ...
            <p className="">
              Basically everything that is a resource for the Lisk ecosystem can be submitted. So let's say a (d)App, pool, guide, community can be submitted to LiskHunt.<br/>
              In order to submit a new hunt, you can create a new <strong>Pull-Request</strong> to our repository on Github. You'll just need to add the app to <code>resource.json</code>, commit and submit the PR.
            </p>
            <div className="top40 bottom40 columms">
              <div className="column is-half is-offset-one-quarter">
                <a className="button is-success right30 top15"> <i className="fa fa-github" /> Submit on Github</a>
                <a className="button is-warning top15" onClick={this.togleHideManualSubmit}>Submit without Github</a>
              </div>
            </div>
            ...
            {/*<CSSTransitionGroup>*/}
                ...
                No problem, please send an email to <br/><code>carbonara [at] lisk.rocks</code><br/> covering the following fields:
